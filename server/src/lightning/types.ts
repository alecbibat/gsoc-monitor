// Wire contract for the lightning endpoints. The client keeps an identical copy
// in client/src/types/lightning.ts — change both together.
//
// Strikes travel quantized: latQ/lonQ are 20-bit grid indices (≈19 m lat /
// ≈38 m lon steps, see quant.ts) and time is 10 ms "ticks" since the epoch.
