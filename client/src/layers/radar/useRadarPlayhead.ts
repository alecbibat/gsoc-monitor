...
// named, play state, loading progress; `buffering` is diagnostics only). The engine publishes every animation
...
export type CoarsePlayhead = Omit<PlayheadState, 'position' | 'buffering'>;
